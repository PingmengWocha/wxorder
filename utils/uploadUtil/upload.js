...
const uploadFile = function(params) {
  ...
  var name = new Date().getTime() + apiUtil.randomWord(false, 16) + "." + params.filePath.substring(params.filePath.lastIndexOf('.') + 1);
...
const getPolicyBase64 = function() {
  ...
  console.log(date.setHours(date.getHours() + env.timeout))
